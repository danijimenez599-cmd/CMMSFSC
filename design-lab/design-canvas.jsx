...
const DC = {
  bg: 'var(--dc-bg, #f0eee9)',
  grid: 'var(--dc-grid, rgba(0,0,0,0.06))',
  label: 'var(--dc-label, rgba(60,50,40,0.7))',
  title: 'var(--dc-title, rgba(40,30,20,0.85))',
  subtitle: 'var(--dc-sub, rgba(60,50,40,0.6))',
  postitBg: 'var(--dc-postit-bg, #fef4a8)',
  postitText: 'var(--dc-postit-text, #5a4a2a)',
...
function DCViewport({ children, minScale = 0.1, maxScale = 8, style = {} }) {
  ...
  return (
    ...
    >
      ...
      >
        <svg style={{ position: 'absolute', top: -6000, left: -6000, width: '12000px', height: '12000px', pointerEvents: 'none', zIndex: -1 }}>
          <defs>
            <pattern id="dc-grid" width="120" height="120" patternUnits="userSpaceOnUse">
              <path d="M120 0H0v120" fill="none" stroke={DC.grid} strokeWidth="1" />
            </pattern>
          </defs>
