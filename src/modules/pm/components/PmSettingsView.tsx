...
export default function PmSettingsView() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-8">
      {/* Tab Navigation */}
      <div className="flex items-center gap-1 p-1 bg-bg-2 rounded-2xl border border-border w-fit max-w-full overflow-x-auto no-scrollbar snap-x shrink-0">
        <button
          onClick={() => setActiveTab('magnitudes')}
          className={cn(
            "flex items-center gap-2 px-4 sm:px-5 py-2.5 rounded-xl text-sm font-semibold transition-all shrink-0 snap-start",
